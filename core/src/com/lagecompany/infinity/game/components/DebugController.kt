...
class DebugController : StageObject() {
    private val debugAdapter = object : InputAdapter() {
    ...
    override fun initialize() {
        Debug.ifEnabled {
            currentStage().addInputProcessor(debugAdapter)
        }
    }

    override fun dispose() {
        Debug.ifEnabled {
            currentStage().removeInputProcessor(debugAdapter)
        }
    }
}